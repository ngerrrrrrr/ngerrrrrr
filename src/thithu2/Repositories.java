...
public class Repositories {
    ...
    public ArrayList<Model> getAll() {
        ...
        ArrayList<Model> list_NV = new ArrayList<>();
        try {
            ...
            while (rs.next()) {
                ...
                list_NV.add(new Model(ma, ten, pass, vaiTro));
            }
            return list_NV;
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public int sua(String ma, Model m){
    ...
    public Model checkTrung(String maMoi){
        Model m = null;
         try {
            con = DBConnect.getConnection();
            ps = con.prepareStatement(sql);
            ...
            while (rs.next()) {
                ...
                String pass = rs.getString(3);
                boolean vaiTro = rs.getBoolean(4);
                m = new Model(ma, ten, pass, vaiTro);
            }
            return m;
        } catch (Exception e) {
            e.printStackTrace();
